...
# A simple Paint App, nothing special
class PaintApp:
    # The starting drawing tool is the pencil
    drawing_tool = "pencil"
    left_button = "up"
    ...
    def text_draw(self, event=None):
        if  None not in (self.x1_line_pt, self.y1_line_pt):
            ...
            event.widget.create_text(self.x1_line_pt, self.y1_line_pt, fill="lightblue", font=text_font, text="Example Text!")
root = Tk()
